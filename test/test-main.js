...
const simplePrefs = require('sdk/simple-prefs'),
    ...
    { adjustSortCriteria, createEvents, migrateOptions, setPreferenceMinimumMaximum } = require('main'),
    { sleep, spawn } = require('./task'),
    { assertBookmarksArray, createBookmark, createFolder, createLivemark, createSeparator, createSmartBookmark, deleteAllBookmarks, deleteItem, move, rename, resetPreferences, setVisits } = require('./utils');
...
exports.testAutoSortOnChanges = function(assert, done) {
    spawn(function() {
        adjustSortCriteria();
        createEvents();
        prefs.auto_sort = true;
...
exports.testAutoSortOnOptionChanges = function(assert, done) {
    spawn(function() {
        adjustSortCriteria();
        createEvents();
...
exports.testAutoSortDelay = function(assert, done) {
    spawn(function() {
        adjustSortCriteria();
        createEvents();
