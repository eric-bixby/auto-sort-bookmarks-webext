...
function sortAllBookmarks() {
    // resource://sortbookmarks-at-bouanto/
    // var myWorker = new BasePromiseWorker(data.url('worker.js'));
    // var promise = myWorker.post('sortAll', [bookmarkSorter.getAllFolders()]);
    // promise.then(
    //     function(aVal) {
