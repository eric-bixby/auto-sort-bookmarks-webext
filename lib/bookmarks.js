...
let Bookmark = new Class({
    extends: Item,
    garbageCharacters: 'þþþþþþþþþþþþþþþþþþþþþþþþþþ',
    /**
     * Get a bookmark.
    ...
    initialize: function(itemID, index, parentID, title, dateAdded, lastModified, url, lastVisited, accessCount) {
        ...
        this.title = title || this.garbageCharacters;
        this.url = url || this.garbageCharacters;
        ...
        this.description = getDescription(this) || this.garbageCharacters;
        this.setKeyword();
    },
    /**
     ...
     */
    setKeyword: function() {
        let keyword = this.garbageCharacters;
        try {
            keyword = bookmarkService.getKeywordForBookmark(this.id);
            keyword = keyword || this.garbageCharacters;
        }
        catch(exception) {
            // Nothing to do.
        }
