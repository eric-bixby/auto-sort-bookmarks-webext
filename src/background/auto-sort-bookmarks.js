  ...
  createCompare() {
    ...
    if (
      ...
      firstComparator = function(bookmark1, bookmark2) {
        ...
        return (
          bookmark1[BookmarkSorter.prototype.firstSortCriteria].localeCompare(
            bookmark2[BookmarkSorter.prototype.firstSortCriteria],
            undefined,
            compareOptions
          ) * BookmarkSorter.prototype.firstReverse
        );
      };
    } else {
    ...
    if (
      BookmarkSorter.prototype.secondSortCriteria !== undefined &&
        ...
        secondComparator = function(bookmark1, bookmark2) {
          ...
          return (
            bookmark1[
              ...
              undefined,
              compareOptions
            ) * BookmarkSorter.prototype.secondReverse
          );
        };
      } else {
        // sort numerically: dateAdded, lastModified, accessCount, lastVisited
    ...
    if (BookmarkSorter.prototype.differentFolderOrder) {
      if (
        BookmarkSorter.prototype.folderSortCriteria !== undefined &&
        ...
        comparator = function(bookmark1, bookmark2) {
          if (bookmark1 instanceof Folder && bookmark2 instanceof Folder) {
            if (
              ...
              return (
                bookmark1[
                  BookmarkSorter.prototype.folderSortCriteria
                ].localeCompare(
                  bookmark2[BookmarkSorter.prototype.folderSortCriteria],
                  undefined,
                  compareOptions
                ) * BookmarkSorter.prototype.folderReverse
              );
            }

            // numeric sort
            return (
              (bookmark1[BookmarkSorter.prototype.folderSortCriteria] -
                bookmark2[BookmarkSorter.prototype.folderSortCriteria]) *
              BookmarkSorter.prototype.folderReverse
            );
          }
...
class Annotations {
  ...
  hasRecursiveAnnotation(id) {
    if (
      storedSettings !== undefined &&
      storedSettings[RECURSIVE] !== undefined &&
  ...
  removeItemAnnotation(name, id) {
    if (
      storedSettings !== undefined &&
      storedSettings[name] !== undefined &&
      storedSettings[name][id] !== undefined
    ) {
